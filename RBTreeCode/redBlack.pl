...
rb_search( t( b, nil, nil, nil ), _ ) :- !, print(false).
rb_search( t( _, K, _, _ ), K ):-print(K).
...
error:-
borraPantalla,
escribe("No eligió una opción"), nl,
...
%Limpiar Arbol
cleanTree(_,NTree):-
escribe("Limpiando Arbol: "),
rb_empty(NTree).

% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% %%%%% Insertar numero
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
insertar(t(_,nil,nil,nil),NTree):-
escribe("Digite el elemento a agregar1: "),read(N),
	rb_insert(_,N, NTree),
	rb_print(NTree),!.

insertar(Tree,NTree):-
escribe("Digite el numero a agregar2: "),read(N),
	rb_insert(Tree,N, NTree),
	rb_print(NTree).
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
eliminar(Tree,NTree):-
escribe("Digite el elemento a eliminar: "),read(N),
	rb_delete(Tree,N,NTree).

% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% %%%%% Buscar Numero
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
buscar(Tree):-
escribe("Digite el elemento a buscar: "),read(N),
	rb_search(Tree,N).
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
inorden(Tree):-
	rb_inOrder(Tree,Lista),
	print(Lista).
%------------------------- opciones ---------------------------------
opciones(X,T,TN,THilera,TNHilera):-
( (X = a) ->
cleanTree(T,TN),nl,
pausa,menu(TN,THilera);
(X = b) ->
cleanTree(THilera,TNHilera),nl,
pausa,menu(T,TNHilera);
(X = c) ->
insertar(T,TN),nl,
pausa,menu(TN,THilera);
(X = d) ->
insertar(THilera,TNHilera),nl,
pausa,menu(T,TNHilera);
(X = e) ->
eliminar(T,TN),nl,
pausa,menu(TN,THilera);
(X = f) ->
eliminar(THilera,TNHilera),nl,
pausa,menu(T,TNHilera);
(X = g) ->
buscar(THilera),nl,
pausa,menu(T,THilera);
(X = h) ->
buscar(T),nl,
pausa,menu(T,THilera);
(X = i) ->
...
menu(T,THilera):-
borraPantalla,
escribe("1.Red-Black Tree"),nl,
escribe("Digite su obcion:"),nl,
tab(10),escribe("a) Limpiar Arbol de numeros"),nl,
tab(10),escribe("b) Limpiar Arbol de Hileras"),nl,
tab(10),escribe("c) Agregar numero al árbol"),nl,
tab(10),escribe("d) Agregar hilera al árbol"),nl,
tab(10),escribe("e) Eliminar número del árbol"),nl,
tab(10),escribe("f) Eliminar hilera de árbol"),nl,
tab(10),escribe("g) Buscar Hilera"),nl,
tab(10),escribe("h) Buscar numero"),nl,
tab(10),escribe("i) Inorden de numeros"),nl,
tab(10),escribe("j) Inorden de Hileras"),nl,
tab(10),escribe("k) Pretty-Print Hileras"),nl,
tab(10),escribe("l) Pretty-Print numeros"),nl,
tab(10),escribe("m) Salir"),nl,
